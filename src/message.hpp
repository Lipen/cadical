...
#define MSG(...)                                      \
    do {                                              \
        if (internal) internal->message(__VA_ARGS__); \
    } while (0)

#define PHASE(...)                                  \
    do {                                            \
        if (internal) internal->phase(__VA_ARGS__); \
    } while (0)

#define SECTION(...)                                  \
    do {                                              \
        if (internal) internal->section(__VA_ARGS__); \
    } while (0)

#define VERBOSE(...)                                  \
    do {                                              \
        if (internal) internal->verbose(__VA_ARGS__); \
    } while (0)
